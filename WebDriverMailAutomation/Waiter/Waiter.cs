...
namespace Waiter
{
    ...
    public class Waiter
    {
        ...
        public Waiter(IWebDriver driver, int waitTime)
        {
            Driver = driver;
            WaitTime = waitTime;
        }
        ...
        public void WaitElementIsVisible(By webElementLocator)
        {
        ...
        /// </summary>
        /// <param name="webElementLocator">Web element locator.</param>
        public void WaitElementToBeClickable(By webElementLocator)
        {
            new WebDriverWait(Driver, new TimeSpan(0, 0, 0, 0, WaitTime)).
